...
const saintInfo = {
    ...
    "demiana": {
        name: "القديسة دميانة",
        image: "images/demiana.png"
    },

    "antonios": {
        name: "القديس الأنبا أنطونيوس",
        image: "images/antonios.png"
    },
    ...
    "george-alex": {
        ...
        image: "images/george-alex.png"
    },

    "bishoy": {
        name: "القديس الأنبا بيشوي",
        image: "images/bishoy.png"
    },
    ...
    "akhmim-martyrs": {
        name: "شهداء أخميم",
        image: "images/akhmim-martyrs.png"
    },

    "fayoum-martyrs": {
        name: "شهداء الفيوم",
        image: "images/fayoum-martyrs.png"
    },
    ...
    image: "images/cyril-the-pillar.png"
    },

    "abaskhiron": {
    name: "الشهيد أباسخيرون القليني",
    image: "images/abaskhiron.png"
    },

    "bishoy-kamel": {
    name: "أبونا بيشوي كامل",
    image: "images/bishoy-kamel.png"
    }
...
storyData.hymn.forEach(row => {
    ...
    hymnText.innerHTML += `
        <div class="hymnRow" style="grid-template-columns:repeat(${row.length},1fr)">
            ${columns}
        </div>
    `;
